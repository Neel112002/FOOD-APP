...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  var products = [
    {"name": "Chinese side ", "image": "assets/image/food0.png"},
    {"name": "Mexcian ", "image": "assets/image/food1.png"}
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // SizedBox(height: 50), //slider section
          SizedBox(
            // color: Colors.red,
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: BigText(
                                  text: "SVIT CANTEEN APP FOR STUDENTS",
                                ),
                              ),
                              SizedBox(
      ...
      child: Stack(children: [
        ...
        Align(
            ...
            child: Container(
              ...
              child: Container(
                padding: EdgeInsets.only(
                    top: Dimensions.height10, left: 12, right: 12),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
